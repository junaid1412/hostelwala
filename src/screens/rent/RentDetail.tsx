...
export class RentDetail extends React.Component {
    ...
    getTabs(showAddTab: boolean) {
        const tabs = this.state.currentTabs.map((tab) => this.renderTabs(tab));
